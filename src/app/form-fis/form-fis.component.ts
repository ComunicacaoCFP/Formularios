...
@Component({
  selector: 'app-form-fis',
  imports: [],
  templateUrl: './form-fis.component.html',
  styleUrl: './form-fis.component.css'
})
export class FormFisComponent {
  formObject = {
    lab: "",
    docente: "",
    compCurr: "",
    ...
    numEx: "",
    qtdKit: "",
    emailTo: "aline.oliveira@ufrb.edu.br, danielmelo@ufrb.edu.br, moises@ufrb.edu.br, evandroq@ufrb.edu.br"
  }
  ngOnInit(){
  ...
  public sendEmail(e: Event) {
    ...
    const vol = document.querySelector("input[name=vol]");
    this.formObject["vol"] = (<HTMLInputElement> vol).value;
    const revLiv = document.querySelector("input[name=revLiv]");
    this.formObject["revLiv"] = (<HTMLInputElement> revLiv).value;
    const pag = document.querySelector("input[name=pag]");
    this.formObject["pag"] = (<HTMLInputElement> pag).value;
    const numEx = document.querySelector("input[name=numEx]");
    this.formObject["numEx"] = (<HTMLInputElement> numEx).value;
    const qtdKit = document.querySelector("input[name=qtdKit]");
    this.formObject["qtdKit"] = (<HTMLInputElement> qtdKit).value;
    ...
    emailjs
      .send('service_u70ats4', 'template_f77fzr4', this.formObject, {
